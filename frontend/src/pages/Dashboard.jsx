      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="space-x-2">
            <button className="px-4 py-2 border border-blue-600 rounded-lg text-blue-600 hover:bg-blue-50">Report Item</button>
        ...
        <div className="flex space-x-4 overflow-x-auto pb-4">
            {/* Card 1 */}
            <div className="min-w-[200px] bg-white rounded-xl shadow p-4">
                <img src="https://via.placeholder.com/150" alt="Backpack" className="rounded mb-2 w-full" />
            ...
            {/* Card 2 */}
            <div className="min-w-[200px] bg-white rounded-xl shadow p-4">
                <img src="https://via.placeholder.com/150" alt="Eyeglasses" className="rounded mb-2 w-full" />
                <h3 className="text-lg font-bold">Eyeglasses</h3>
            ...
            <div className="min-w-[200px] bg-white rounded-xl shadow p-4">
                <img src="https://via.placeholder.com/150" alt="Wallet" className="rounded mb-2 w-full" />
